...
namespace OS_CodeFirst.BD {
    ...
    public partial class ordemservicoDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ordemservicoDataSet1.xsd";
        ...
        public partial class funcionarioDataTable : global::System.Data.TypedTableBase<funcionarioRow> {
            ...
            private void InitClass() {
                ...
                this.columnRF.AllowDBNull = false;
        ...
        public partial class funcionarioRow : global::System.Data.DataRow {
            ...
            public string RF {
                get {
                    return ((string)(this[this.tablefuncionario.RFColumn]));
                }
                set {
                    this[this.tablefuncionario.RFColumn] = value;
                }
            }
...
namespace OS_CodeFirst.BD.ordemservicoDataSetTableAdapters {
    ...
    public partial class funcionarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `funcionario` WHERE ((`Id` = @p1) AND (`RF` = @p2) AND (`Nome` = @p3)" +
                " AND (`Setor` = @p4))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `funcionario` (`RF`, `Nome`, `Setor`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `funcionario` SET `RF` = @p1, `Nome` = @p2, `Setor` = @p3 WHERE ((`Id` = @" +
                "p4) AND (`RF` = @p5) AND (`Nome` = @p6) AND (`Setor` = @p7))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Id`, `RF`, `Nome`, `Setor` FROM `funcionario`";
        ...
        public virtual int Fill(ordemservicoDataSet.funcionarioDataTable dataTable) {
        ...
        public virtual ordemservicoDataSet.funcionarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ordemservicoDataSet.funcionarioDataTable dataTable = new ordemservicoDataSet.funcionarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ordemservicoDataSet.funcionarioDataTable dataTable) {
